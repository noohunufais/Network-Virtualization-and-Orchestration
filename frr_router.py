...
def create_router(client, network_name):
    """
    Create and configure the FRR router container.
    Uses local AS 1 and router-id 1.1.1.1.
    """
    container = create_container(client, "frr_router", network_name)
